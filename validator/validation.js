...
//Length of password should be a minimum of 8 characters with no maximum length restriction.
...
//Validates if the input string represents a valid price.
//Digit(s) with optional thousands separators (,) and cents (up to two decimal places).
//Example of valid price are :- "100", "1,000", "10,000.00", "99.99".
//Example of invalid price are :- "10.123", "1,00", "abc", "-10.50"
